...
/* 	if(mysqli_num_rows($result) == 0)
	{ */
		...
		if (!filter_var($_POST['long_url'], FILTER_VALIDATE_URL) === false) 
		{
			...
			if($query)
			{
				$msg = "<p align=right><b>رابطك القصير الجديد :</b>: <a href='".$short_url."'>$short_url</a></p>";
			}
			else
			{
				$msg = "توجد مشكله غير معروفة !!";
			}
		} 
		else 
		{
			$msg = "<p align=right>هذا الرابط غير صالح للإستخدام </p>";
		}
/* 	}
	else
	{
		$msg = "<p align=right>الرابط هذا مستخدم من قبل!</p>";
	} */
}
?>